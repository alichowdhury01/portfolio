    ...
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className=" mt-4">
          ...
          Electric Vehicle and new tech enthusiast, a travel aficionado
        ...
        <Paragraph className=" mt-4">
          ...
          food, travel, EVs, and new tech. When I&apos;m not busy
          conjuring up new projects, you&apos;ll find me exploring the world,
          trying out new cuisines, or geeking out over the latest gadgets and
          Electric Vehicles.
        </Paragraph>
        <Paragraph className=" mt-4">
        ...
        <Paragraph className=" mt-4">
          ...
          solutions, a design enthusiast looking for inspiration, or just someone
          looking to connect, I&apos;m excited to have you here.
        </Paragraph>
        <Paragraph className=" mt-4">
